...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/mark-util-chunked
   cd mark-util-chunked
   ```
...
```sh
https://github.com/flex-development/mark-util-chunked/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/mark-util-chunked/discussions/new?category=q-a
